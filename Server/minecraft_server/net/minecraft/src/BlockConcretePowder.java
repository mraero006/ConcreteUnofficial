...
public class BlockConcretePowder extends Block {
	...
	private void tryToFall(World var1, int var2, int var3, int var4) {
		if (canFallBelow(var1, var2, var3 - 1, var4) && var3 >= 0) {
			byte var8 = 32;
			if (!fallInstantly && var1.checkChunksExist(var2 - var8, var3 - var8, var4 - var8, var2 + var8, var3 + var8,
					var4 + var8)) {
				EntityFallingConcrete var9 = new EntityFallingConcrete(var1, (double) ((float) var2 + 0.5F),
	...
	/*
	 * protected int damageDropped(int var1) { return var1; }
	 */
